		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "HTF 2021: Cluedo",
									"targetURL": "#HTF2021:Cluedo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"HTF2021:Cluedo-display": {
								"semanticObject": "HTF2021:Cluedo",
								"action": "display",
								"description": "A Cluedo game in SAP UI5",
								"title": "HTF 2021: Cluedo",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.flexso.htf2021",
									"url": sap.ui.require.toUrl("com/flexso/htf2021")
								}
							}
						}
					}
